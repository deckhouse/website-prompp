# AGENTS.md for Deckhouse Prom++

This repository contains Hugo-based documentation for the Deckhouse Prom++.
...
- EN: <http://localhost/products/prompp/documentation/>
- RU: <http://ru.localhost/products/prompp/documentation/>
