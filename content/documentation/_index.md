...
Deckhouse Prom++ implements PromQL (Prometheus Query Language), a query language that allows flexible operations with metrics over time (e.g., summing, averaging, sampling by labels).
